        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.framesContainer}>
                    <View style={styles.catagoryContainor}>
                        <TouchableOpacity style={this.state.selected=="regular"?styles.catagoryBoxSelected:styles.catagoryBox}onPress={()=>this.setState({selected: `regular`})}>
                            <Text>Regular</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={this.state.selected=="round"?styles.catagoryBoxSelected:styles.catagoryBox}onPress={()=>this.setState({selected: `round`})}>
                            <Text>Round</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={this.state.selected=="wayfarer"?styles.catagoryBoxSelected:styles.catagoryBox}onPress={()=>this.setState({selected: `wayfarer`})}>
                            <Text>Wayfarer</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={this.state.selected=="aviator"?styles.catagoryBoxSelected:styles.catagoryBox}onPress={()=>this.setState({selected: `avioator`})}>
                            <Text>Aviator</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={this.state.selected=="rimless"?styles.catagoryBoxSelected:styles.catagoryBox}onPress={()=>this.setState({selected: `rimless`})}>
                            <Text>Rimless</Text>
                        </TouchableOpacity>
                    </View>
